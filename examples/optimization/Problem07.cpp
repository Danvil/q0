...
typedef Spaces::TypelistState<LOKI_TYPELIST_3(state0,state1,state2)> state;
...
typedef Spaces::TypelistSpace<LOKI_TYPELIST_3(space0,space1,space2), state> space;
...
int main(int argc, char** argv)
{
	...
	Functions::BoostFunctionSingleWrapper<state> f;
